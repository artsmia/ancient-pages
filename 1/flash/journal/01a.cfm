...
<table border="0" cellspacing="0" cellpadding="0" height="267" vspace="0" hspace="0">
  ...
  <tr> 
    ...
    <td align="left" valign="top" rowspan="3" background="../jPaper.gif" width="163"> 
	  ...
	  January 7<br>
Conservators evaluate the painting's condition and write a report. They note the present condition of the painting's support, and the layers of paint, from the surface layers through to the ground layers. They recommend techniques for restoring the painting.
<br><img src="lg910_01.jpg width=160 height="120" border="0">
</font></p>
      </cfoutput></td>
    <td align="left" valign="top" rowspan="3"> <img src="../jMspir.gif" width="25" height="210" vspace="0" hspace="0" border="0"></td>
    <td align="left" valign="top" rowspan="3" background="../jPaper.gif" width="163"> 
      <p>July 26, 11 a.m.<br>
This is our last chance to view Castiglione's masterwork up close as it hangs in the gallery, before conservators remove the painting and prepare it for restoration.</p>
      </td>
